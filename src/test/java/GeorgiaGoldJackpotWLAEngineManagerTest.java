...
public class GeorgiaGoldJackpotWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(GeorgiaGoldJackpotWLAEngineManagerTest.class);
		logger.setLevel(Level.DEBUG);
		gameParams = XMLUtil.parseResource("paymodel/GeorgiaGoldJackpotWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/GeorgiaGoldJackpotWLAIW/InitOutcome.xml").getDocumentElement();
